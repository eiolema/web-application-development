    ...
    <div class="container">
        <div class="login">
            <form @submit.prevent="validateForm">
                ...
                <br>
                <input v-if="logInForm" type="submit" class="submit" name="login" value="Log In" style="margin-right: 10px">
                <input v-if="logInForm" @click="changeForm" type="button" class="submit" name="login" value="Sign Up">
                <input v-if="!logInForm" type="submit" class="submit" name="login" value="Sign Up">
                <br>
            </form>
        </div>
    </div>
